                ...
                <div class="ui-grid-b">
                    <div class="ui-block-a" style="width: 100% !important;">
                        <div class="ui-bar ui-bar-a" style="font-size: 15px; padding-top: 0px; padding-bottom: 0px;">
                            <button id="btn-add" type="submit" value="Thêm dòng" data-inline="true" style="height: 30px !important; font-size: 15px !important; padding: 0px 10px 0px 10px;">Thêm dòng</button>
